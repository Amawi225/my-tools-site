const T = {
  ar: {
    ...
    hero_label:'أدوات موثوقة يستخدمها الملايين',
    badge_langs:'6 لغات', stat_tools:'أداة مجانية', stat_langs:'لغات مدعومة',
    stat_private:'خاص وآمن', stat_ads:'إعلانات',
    section_tools:'جميع الأدوات', section_tools_sub:'اختر الأداة التي تحتاجها',
    footer_desc:'مجموعة أدوات إلكترونية مجانية تعمل مباشرة في متصفحك. بدون تسجيل، بدون إعلانات، خصوصيتك محفوظة.',
    ...
    qr_download:'تنزيل الصورة', qr_hint:'اكتب أي رابط أو نص لتوليد الرمز',
  ...
  en: {
    ...
    hero_label:'Trusted by millions worldwide',
    badge_langs:'6 Languages', stat_tools:'Free Tools', stat_langs:'Languages',
    stat_private:'Private & Secure', stat_ads:'Ads',
    section_tools:'All Tools', section_tools_sub:'Choose the tool you need',
    footer_desc:'A collection of free online tools that work directly in your browser. No registration, no ads, your privacy is protected.',
    ...
    qr_download:'Download Image', qr_hint:'Type any link or text to generate the code',
  ...
  fr: {
    ...
    hero_label:'Utilisé par des millions dans le monde',
    badge_langs:'6 Langues', stat_tools:'Outils gratuits', stat_langs:'Langues',
    stat_private:'Privé et sécurisé', stat_ads:'Publicités',
    ...
    qr_download:'Télécharger l\'image', qr_hint:'Entrez un lien ou un texte pour générer le code',
  ...
  es: {
    ...
    hero_label:'Usado por millones en todo el mundo',
    badge_langs:'6 Idiomas', stat_tools:'Herramientas', stat_langs:'Idiomas',
    stat_private:'Privado y seguro', stat_ads:'Anuncios',
    ...
    qr_download:'Descargar imagen', qr_hint:'Escribe un enlace o texto para generar el código',
  ...
  de: {
    ...
    hero_label:'Von Millionen weltweit genutzt',
    badge_langs:'6 Sprachen', stat_tools:'Kostenlose Tools', stat_langs:'Sprachen',
    stat_private:'Privat und sicher', stat_ads:'Werbung',
    ...
    qr_download:'Bild herunterladen', qr_hint:'Geben Sie einen Link oder Text ein',
  ...
  ru: {
    ...
    hero_label:'Используется миллионами по всему миру',
    badge_langs:'6 Языков', stat_tools:'Бесплатных инструментов', stat_langs:'Языков',
    stat_private:'Конфиденциально', stat_ads:'Рекламы',
    ...
    qr_download:'Скачать изображение', qr_hint:'Введите ссылку или текст для генерации кода',
