const T = {
  ar: {
    ...
    qmath_card_title:'سرعة الحساب', qmath_card_desc:'أجب على 10 أسئلة رياضية قبل انتهاء الوقت!',
  ...
  en: {
    ...
    qmath_card_title:'Quick Math', qmath_card_desc:'Answer 10 math questions before time runs out!',
  ...
  fr: {
    ...
    qmath_card_title:'Maths Rapides', qmath_card_desc:'Répondez à 10 questions de maths avant la fin du temps!',
  ...
  es: {
    ...
    qmath_card_title:'Matemáticas Rápidas', qmath_card_desc:'¡Responde 10 preguntas antes de que se acabe el tiempo!',
  ...
  de: {
    ...
    qmath_card_title:'Schnelle Mathe', qmath_card_desc:'Beantworte 10 Mathe-Fragen vor Ablauf der Zeit!',
  ...
  ru: {
    ...
    qmath_card_title:'Быстрая математика', qmath_card_desc:'Ответьте на 10 вопросов до окончания времени!',
