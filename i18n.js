const T = {
  ar: {
    ...
    hero_sub:'أدوات دقيقة وسريعة، تعمل مباشرة على متصفحك — بدون تسجيل، استخدام مجاني 100%',
  ...
  en: {
    ...
    hero_sub:'Fast and accurate tools that run directly in your browser — no registration, 100% free',
